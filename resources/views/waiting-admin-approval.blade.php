@extends(config('admin-approver.views.layout'))

@section('content')
<div class="bg-gray-200 dark:bg-gray-600 flex justify-center mt-20">
    <div class="text-center">
        <h2 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Registration Status:</h2>
